...
# Batch processing of images using dark channel prior haze removal
data_path = 'defog_in/'
...
for img_name in img_list:
    ...
    name = img_name[:-4]
    print('defog processing......')

    m = defog.deHaze(img / 255.0) * 255
    cv2.imwrite(out_path + name + "_defog.jpg", m)
    print("Done!")
